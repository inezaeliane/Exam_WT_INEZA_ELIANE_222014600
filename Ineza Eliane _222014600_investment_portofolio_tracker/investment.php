...
<div class="sidebar">
    ...
    <form action="investment_read_insert.php" method="POST" onsubmit="return confirmInsert();">
        ...
        <select id="type_of_investment" name="type_of_investment" required>
        ...
        <input type="text" id="purchase_price" name="purchase_price" required><br>
        
        <label for="purchase_date">Purchase Date:</label>
        <input type="date" id="purchase_date" name="purchase_date" required><br>
        
        <label for="current_value">Current Value:</label>
        <input type="text" id="current_value" name="current_value" required><br>
        
        <label for="dividends">Dividends:</label>
        <input type="text" id="dividends" name="dividends" required><br>
