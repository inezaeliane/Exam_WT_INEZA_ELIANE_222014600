...
<div class="sidebar">
    ...
    <div class="main--content">
        ...
        <div class="container">
        <h2>Performance</h2>
        <form action="performance_read_insert.php" method="post" onsubmit="return confirmInsert();">
    ...
    <input type="number" id="total_return" name="total_return" step="0.01" required>

    <label for="annualized_return">Annualized Return:</label>
    <input type="number" id="annualized_return" name="annualized_return" step="0.01" required><br><br>

    <label for="volatility">Volatility:</label>
    <input type="number" id="volatility" name="volatility" step="0.01" required>

    <label for="sharpe_ratio">Sharpe Ratio:</label>
    <input type="number" id="sharpe_ratio" name="sharpe_ratio" step="0.01" required>
